...
class database extends PDO{
	...
	public function __construct($_CONFIG,$options=array()){
	...
	public function getAccountByUID($uid){
		return $this->getRow("SELECT * FROM accounts WHERE uid=?",array($uid));
	}
	public function getAccountByUsername($user){
		return $this->getRow("SELECT * FROM accounts WHERE username=?",array($user));
	}
}
?>